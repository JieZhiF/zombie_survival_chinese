hook.Add( "PostGamemodeLoaded", "zsinv", function()
    local getGM = gmod.GetGamemode()

    if getGM.Name == 'Zombie Survival' then
        getGM.ZSInventory = {}
        ...
        function getGM:CreateInventoryElements()
            local screenscale = BetterScreenScale()
        ...
        function getGM:InventoryAddGridItem( item, category )
            local screenscale = BetterScreenScale()
        ...
        function getGM:InventoryRemoveGridItem( item )
        ...
        function getGM:InventoryWipeGrid()
            for i, grid in pairs( self.InventoryMenu.Grids ) do
                for k, v in pairs( grid:GetChildren() ) do
                    grid:RemoveItem( v )
                end
