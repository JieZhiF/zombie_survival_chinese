...
GM:SetSkillModifierFunction(SKILLMOD_BLOODARMOR, function(pl, amount)
	...
	local new = 20 + math.Clamp(amount, -20, 1000)          -- -20
...
GM:AddSkillModifier(SKILL_TANKER, SKILLMOD_SPEED, -7.5)   -- -15

GM:AddSkillModifier(SKILL_ULTRANIMBLE, SKILLMOD_HEALTH, -10) -- -20
...
GM:AddSkillModifier(SKILL_GOURMET, SKILLMOD_FOODEATTIME_MUL, 0.5)--原2.0
...
GM:AddSkillModifier(SKILL_HAMMERDISCIPLINE, SKILLMOD_HAMMER_SWING_DELAY_MUL, -0.2)   -- -0.2
GM:AddSkillModifier(SKILL_BARRICADEEXPERT, SKILLMOD_HAMMER_SWING_DELAY_MUL, 0)       -- 0.3
...
GM:AddSkillModifier(SKILL_HAEMOSTASIS, SKILLMOD_BLOODARMOR_DMG_REDUCTION, -0.25)      --血甲吸收减益
--GM:AddSkillModifier(SKILL_HAEMOSTASIS, SKILLMOD_BLOODARMOR, 10)                          --额外修改
...
--GM:AddSkillModifier(SKILL_D_WEAKNESS, SKILLMOD_HEALTH, -0)       -- -45
GM:AddSkillModifier(SKILL_D_WEAKNESS, SKILLMOD_ARSENAL_DISCOUNT, -0.02)       --额外修改
