...
function PANEL:Init()
	...
	button.DoClick = function(me)
		...
		elseif MySelf:IsSkillUnlocked(skillid) then
			...
			self:DisplayMessage(name .. " " .. translate.Get("Skill_ui_unlocked_activated"), COLOR_GREEN)
...
function PANEL:UpdateQuickStats()
	...
	for i=1,3 do
		local prefix = i == 1 and translate.Get("Skill_ui_health") or i == 2 and translate.Get("Skill_ui_speed") or translate.Get("Skill_ui_worth")
