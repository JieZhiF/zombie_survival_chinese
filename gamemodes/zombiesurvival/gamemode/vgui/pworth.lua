...
function MakepWorth()
	...
	local title = EasyLabel(topspace, translate.Get("Worth_MenuTitle"), "ZSHUDFontSmall", COLOR_WHITE)
	title:CenterHorizontal()
	local subtitle = EasyLabel(topspace, translate.Get("Worth_MenuSubtitle"), "ZSHUDFontTiny", COLOR_WHITE)
	...
	if #GAMEMODE.SavedCarts == 0 then
		...
		propertysheet:SwitchToName(translate.Get("Favorites_TabName"))
