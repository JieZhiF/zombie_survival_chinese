-- ============================================================================
-- sh_sigils.lua - 印记（Sigil）目标与逃脱阶段共享逻辑
-- 负责：提供获取/统计地图上印记实体（prop_obj_sigil）的查询函数、
--       印记启用开关（GetUseSigils）、逃脱门检测，以及逃脱阶段
--       （ESCAPESTAGE_NONE/ESCAPE/BOSS/DEATH）的读写；
--       服务端配合 sv_sigils.lua 生成/腐化印记，客户端读取阶段驱动 HUD。
-- ============================================================================
