...
EFFECT.Col1 = Color(245, 163, 12) --Color(225,225,225,225)
EFFECT.Col2 = Color(241, 35, 8)
EFFECT.Speed = 7000
EFFECT.TracerLength = 64
...
Draw the effect
-----------------------------------------------------------]]
local lerpedcol = Color(250, 0, 0, 225)
...
function EFFECT:Render()
	...
	render.DrawBeam(startbeampos, endbeampos, 12, 0, 1, lerpedcol)
end
