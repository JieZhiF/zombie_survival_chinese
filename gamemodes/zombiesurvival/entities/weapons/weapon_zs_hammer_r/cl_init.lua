-- ============================================================================
-- weapon_zs_hammer_r/cl_init.lua - 锤子 R（客户端）：HUD 显示钉子数量与准星
-- 负责：客户端属性、DrawHUD 绘制剩余钉子数和准星圆点
-- ============================================================================
INC_CLIENT()
SWEP.Slot = GAMEMODE:GetWeaponSlot("WeaponSelectSlotRepairTools") -- 武器栏位（修理工具组）
SWEP.SlotGroup = WEPSELECT_REPAIR_TOOL -- 武器分组：修理工具
