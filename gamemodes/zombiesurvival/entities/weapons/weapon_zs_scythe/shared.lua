SWEP.PrintName = ""..translate.Get("weapon_zs_scythe")
SWEP.Description = ""..translate.Get("weapon_zs_scythe_description")
...
SWEP.MeleeDamage = 97.5  * GAMEMODE.LabourTime
SWEP.MeleeRange = 75
SWEP.MeleeSize = 3.5
...
function SWEP:DrawCustomHUD(owner, scrW, scrH)
	local combo = self:GetDTInt(10) or 0
	local screenscale = math.max(scrH / 1080, 0.851) * 1
	local x = scrW - 225 * 0.75 - 32 * screenscale
	local y = scrH - 175
	draw.SimpleText("Combo: " .. combo, font, x, y, Color(248,252,248), TEXT_ALIGN_CENTER)
	draw.SimpleText("Combo: " .. combo, font, x, y, Color(248,252,248), TEXT_ALIGN_CENTER)
end
