...
SWEP.PrintName = ""..translate.Get("weapon_zs_rebarmace")
SWEP.Description = ""..translate.Get("weapon_zs_rebarmace_description")
...
SWEP.DefendingDamageBlockedDefault = 2.9
SWEP.DefendingDamageBlocked = 2.9
GAMEMODE:AttachWeaponModifier(SWEP, WEAPON_MODIFIER_FIRE_DELAY, -0.15)
GAMEMODE:AddNewRemantleBranch(SWEP, 1, ""..translate.Get("weapon_zs_rebarmace_r1"), ""..translate.Get("weapon_zs_rebarmace_r1_description"), function(wept)
