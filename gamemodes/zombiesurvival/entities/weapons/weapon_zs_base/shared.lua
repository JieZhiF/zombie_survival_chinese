...
SWEP.RecoilAutoControl_PerShot = 0.15 -- 每发子弹增加的回正速度
...
-- 后坐力曲线系统 (COD风格渐进)
SWEP.RecoilFirstShotMult = 1.0 -- 首发后坐力倍率 (COD特色: 第一发通常较大)
...
SWEP.RecoilMaxTotalUp = 45 -- 垂直后坐力累积上限(度)
...
SWEP.VisualRecoilPunch = 1.5 -- 枪模后坐冲击感
SWEP.VisualRecoilUp = -1.8 -- 枪模垂直位移
SWEP.VisualRecoilRoll = 2.5 -- 枪模滚转
