SWEP.PrintName = "'"..translate.Get("weapon_zs_gluon")
SWEP.Description = ""..translate.Get("weapon_zs_gluon_description")
...
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 1, ""..translate.Get("weapon_zs_gluon_r1"), ""..translate.Get("weapon_zs_gluon_r1_description"), function(wept)
...
branch.NewNames = {""..translate.Get("weapon_zs_gluon_r1_l1"), ""..translate.Get("weapon_zs_gluon_r1_l2"), ""..translate.Get("weapon_zs_gluon_r1_l3")}

GAMEMODE:AddNewRemantleBranch(SWEP, 2, ""..translate.Get("weapon_zs_gluon_r2"), ""..translate.Get("weapon_zs_gluon_r2_description"), function(wept)
