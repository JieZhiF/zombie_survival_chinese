-- ============================================================================
-- weapon_zs_remantler/shared.lua - 残骸重组器部署武器（共享）
-- 负责：定义残骸重组器的基本属性，部署后生成 prop_remantler 实体用于拆解/重组物品
-- ============================================================================
-- 武器显示名称（本地化键）
SWEP.PrintName = ""..translate.Get("weapon_zs_remantler")
-- 武器描述文本（本地化键）
SWEP.Description = ""..translate.Get("weapon_zs_remantler_description")
...
-- 主攻击（部署）弹药设置：弹匣容量、默认弹药、弹药类型、攻击延迟、全自动
