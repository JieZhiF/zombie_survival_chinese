...
SWEP.PrintName = ""..translate.Get("weapon_zs_harpoon")
SWEP.Description = ""..translate.Get("weapon_zs_harpoon_description")
...
SWEP.BlockPos = Vector(-15, -3, -2)
SWEP.BlockAng = Angle(0, 10, -45)
