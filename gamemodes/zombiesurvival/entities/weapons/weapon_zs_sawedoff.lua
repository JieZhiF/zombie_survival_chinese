...
SWEP.PrintName = ""..translate.Get("weapon_zs_sawedoff")
SWEP.Description = ""..translate.Get("weapon_zs_sawedoff_description")
...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, ""..translate.Get("weapon_zs_sawedoff_r1"), ""..translate.Get("weapon_zs_sawedoff_r1_description"), function(wept)
