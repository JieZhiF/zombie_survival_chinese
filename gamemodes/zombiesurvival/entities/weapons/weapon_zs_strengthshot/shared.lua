SWEP.PrintName = ""..translate.Get("weapon_zs_strengthshot")
SWEP.Description = ""..translate.Get("weapon_zs_strengthshot_description")
...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, ""..translate.Get("weapon_zs_strengthshot_r1"), ""..translate.Get("weapon_zs_strengthshot_r1_description"), function(wept)
	if SERVER then
